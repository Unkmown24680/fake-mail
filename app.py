...
#********************************************************************************
API1='https://temp-mail.id/api/v1/?action=getDomainList'
API2='https://temp-mail.id/api/v1/?action=getMessages&login='
API3='https://temp-mail.id/api/v1/?action=readMessage&login='
#********************************************************************************
